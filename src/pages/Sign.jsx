    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#0B0B0F] text-white px-4">
            ...
            <div className="relative  ">
                ...
                <img src={logo} alt="North Star" className="h-20 mb-4 absolute -top-11 left-1/2 transform -translate-x-1/2" />
                ...
                <div className="bg-[#141421] p-6 md:p-8 rounded-lg w-full max-w-md   ">
                    ...
                    <div className="flex flex-col gap-y-3 mb-5">
                        ...
                        <div className=" h-max">
                            <h2 className="text-xl md:text-2xl font-bold text-center my-6 ">Welcome Back</h2>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 mb-2  rounded bg-[#13131D] border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-600"
                        />

                        <h1 className="text-end text-blue-500 hover:text-blue-300 font-semibold" >Forgot Password?</h1>
                    </div>


                    <button className="w-full bg-[#7D7D7D] py-2 my-6 rounded mb-4 hover:bg-blue-500 transition">
                        Continue with Email
                    </button>
